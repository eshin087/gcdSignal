...
export const COLUMN_HEADER =
  "col-header grid h-11 shrink-0 grid-cols-[6px_16px_minmax(0,1fr)_auto] items-center gap-2 border-b border-black/[0.06] px-3 transition-shadow dark:border-white/[0.06]";
